...
public class InvoiceService {
	...
	public InvoiceResponse change(String id, Invoice invoice) {
		Response response = Iugu.getClient()
	...
	public InvoiceResponse cancel(String id) {
		Response response = Iugu.getClient().target(String.format(CANCEL_URL, id))
		 .request()
		 .put(null);
	...
	public InvoiceResponse refund(String id) {
		Response response = Iugu.getClient().target(String.format(REFUND_URL, id))
		 .request()
		 .post(null);
